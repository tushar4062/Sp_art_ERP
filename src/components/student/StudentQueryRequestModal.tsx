...
const schema = z.object({
  studentName: z.string().trim().min(2, "Name is required (min 2 characters)"),
      ...
      <DialogContent className="rounded-3xl max-w-md border-border/80 shadow-xl">
        ...
        >
          <div className="space-y-1.5">
            ...
            <Input id="query-name" className="rounded-xl" {...register("studentName")} />
            {errors.studentName && (
          ...
          <div className="space-y-1.5">
            <Label htmlFor="query-remarks">Remarks / Query message</Label>
            <Textarea
              id="query-remarks"
              rows={4}
